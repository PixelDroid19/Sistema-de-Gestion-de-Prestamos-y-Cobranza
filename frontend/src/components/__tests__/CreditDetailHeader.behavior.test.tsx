...
describe('CreditDetailHeader behavior', () => {
  ...
  it('preserves the credit title and stacks utilities until there is enough desktop width', () => {
    ...
    expect(getByRole('heading', { name: 'Detalle del crédito' })).toHaveClass('whitespace-nowrap');
    expect(styles).toMatch(/@media \(min-width: 1400px\)\s*\{\s*\.credit-detail-header__top/);
  });
});
