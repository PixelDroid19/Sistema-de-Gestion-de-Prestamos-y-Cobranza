...
const createAssociatesModule = ({ sharedRuntime, auditService } = {}) => {
  ...
  const useCases = {
    ...
    configureAssociateInvestmentTerm: createConfigureAssociateInvestmentTerm({ associateRepository, auditService }),
    ...
    getAssociateMovementsReport: createGetAssociateMovementsReport({ associateRepository }),
