...
- The administrative Excel export keeps the workbook-level comparison at one row per associate and places every associate's financial summary and records in an independent sheet. Totals in an associate sheet never include another associate.
