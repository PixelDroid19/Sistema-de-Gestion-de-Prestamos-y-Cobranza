...
const createCreditsModule = ({ sharedRuntime, auditService } = {}) => {
  ...
  const useCases = {
    ...
    listDagWorkbenchVariables: createListDagWorkbenchVariables({ dagWorkbenchService }),
    createDagWorkbenchVariable: createCreateDagWorkbenchVariable({ dagWorkbenchService }),
