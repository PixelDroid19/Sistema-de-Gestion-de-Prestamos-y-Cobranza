...
const { moneyColumn, numericGetter } = require('./columnTypes');
...
const Payment = sequelize.define('Payment', {
  ...
  principalApplied: moneyColumn('principalApplied', { allowNull: false, defaultValue: 0, validate: { min: 0 } }),
  interestApplied: moneyColumn('interestApplied', { allowNull: false, defaultValue: 0, validate: { min: 0 } }),
  penaltyApplied: moneyColumn('penaltyApplied', { allowNull: false, defaultValue: 0, validate: { min: 0 } }), // Late fee/penalty portion
  overpaymentAmount: moneyColumn('overpaymentAmount', { allowNull: false, defaultValue: 0, validate: { min: 0 } }),
  remainingBalanceAfterPayment: moneyColumn('remainingBalanceAfterPayment', { allowNull: false, defaultValue: 0, validate: { min: 0 } }),
