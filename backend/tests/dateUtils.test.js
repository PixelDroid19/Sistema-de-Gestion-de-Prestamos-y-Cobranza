...
test('date utilities reject malformed and out-of-range operational years', () => {
  ...
  assert.throws(() => normalizeDateOnly('2026-02-31', 'dueDate'), ValidationError);
  assert.throws(() => normalizeDateOnly('60620-02-02', 'dueDate'), ValidationError);
  assert.throws(() => normalizeOperationalDate('+060517-02-14T00:00:00.000Z', 'paymentDate'), ValidationError);
