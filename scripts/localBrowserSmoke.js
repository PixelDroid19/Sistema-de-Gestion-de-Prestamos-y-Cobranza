...
const resolveBrowserSmokeConfig = (env = process.env, argv = []) => {
  ...
  return {
    ...
    reportsCashflowTab: env.BROWSER_SMOKE_REPORTS_CASHFLOW_TAB || 'Flujo de caja',
    reportsCashflowHeading: env.BROWSER_SMOKE_REPORTS_CASHFLOW_HEADING || 'Control financiero mensual',
